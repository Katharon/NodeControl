...
- Runs snapshot the selected Control Host at queue time; the Worker prepares control-host-scoped workspaces and dispatch manifests before local/dev or SSH remote Ansible execution.
