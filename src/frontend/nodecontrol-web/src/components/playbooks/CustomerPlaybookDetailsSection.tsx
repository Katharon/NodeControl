...
import { PlaybookDetailsCard } from "@/components/playbooks/PlaybookDetailsCard";
import { getCustomer } from "@/lib/api/customers";
import { hasPermission } from "@/lib/auth/permissions";

type CustomerPlaybookDetailsSectionProps = {
  customerId: string;
  playbookId: string;
};

export function CustomerPlaybookDetailsSection({ customerId, playbookId }: CustomerPlaybookDetailsSectionProps) {
