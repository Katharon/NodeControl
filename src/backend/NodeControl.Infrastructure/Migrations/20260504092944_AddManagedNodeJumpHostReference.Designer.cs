...
namespace NodeControl.Infrastructure.Migrations
{
    ...
    [Migration("20260504092944_AddManagedNodeJumpHostReference")]
    partial class AddManagedNodeJumpHostReference
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NodeControl.Domain.Nodes.ManagedNode", b =>
                {
                    ...
                    b.Property<Guid?>("JumpHostManagedNodeId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("JumpHostManagedNodeId")
            ...
            modelBuilder.Entity("NodeControl.Domain.Nodes.ManagedNode", b =>
                {
                    ...
                    b.HasOne("NodeControl.Domain.Nodes.ManagedNode", null)
                        .WithMany()
                        .HasForeignKey("JumpHostManagedNodeId")
                        .OnDelete(DeleteBehavior.Restrict);
